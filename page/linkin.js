...
const songs = [
    {
        ...
        poster:"img/linkin/1.jpg"
    },
    {
        id:2,
        songName: `Numb<br> <div class="subtitle">Linkin Park</div>`,
        poster:"img/linkin/2.jpg"
    },
    {
        id:1,
        songName: `The Messenger<br> <div class="subtitle">Linkin Park</div>`,
        poster:"img/linkin/3.jpg"
    },
    {
        id:2,
        songName: `Shadow of the day<br> <div class="subtitle">Linkin Park</div>`,
        poster:"img/linkin/4.jpg"
    }
...
Array.from(document.getElementsByClassName('playListPlay')).forEach((e)=>{
    e.addEventListener('click',(el)=>{
        index = el.target.id;
        music.src = `audio/linkin/${index}.m4a`;
        poster.src = `img/linkin/${index}.jpg`;
        masterPlay.classList.add('bi-pause-fill')
        masterPlay.classList.remove('bi-play-fill')
        music.play();

        download_music.href = `audio/linkin/${index}.m4a`
