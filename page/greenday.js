...
const songs = [
    {
        ...
        poster:"img/greenday/1.jpg"
    },
    {
        id:2,
        songName: `Good Riddance<br> <div class="subtitle">Greenday</div>`,
        poster:"img/greenday/2.jpg"
    }
...
Array.from(document.getElementsByClassName('playListPlay')).forEach((e)=>{
    e.addEventListener('click',(el)=>{
        index = el.target.id;
        music.src = `audio/greenday/${index}.m4a`;
        poster.src = `img/greenday/${index}.jpg`;
        masterPlay.classList.add('bi-pause-fill')
        masterPlay.classList.remove('bi-play-fill')
        music.play();

        download_music.href = `audio/greenday/${index}.m4a`
